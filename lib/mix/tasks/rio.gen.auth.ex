  ...
  defp files_to_be_generated(%Context{schema: schema, context_app: context_app} = context) do
    ...
    [
      ...
      {:eex, "confirmation_new.html.heex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_confirmation", "new.html.heex"])},
      {:eex, "confirmation_edit.html.heex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_confirmation", "edit.html.heex"])},
      {:eex, "confirmation_controller.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_confirmation", "controller.ex"])},
      {:eex, "confirmation_controller_test.exs",
       Path.join([web_test_prefix, "modules", web_path, "#{schema.singular}_confirmation", "controller_test.exs"])},
      {:eex, "registration_new.html.heex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_registration", "new.html.heex"])},
      {:eex, "registration_controller.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_registration", "controller.ex"])},
      {:eex, "registration_controller_test.exs",
       Path.join([web_test_prefix, "modules", web_path, "#{schema.singular}_registration", "controller_test.exs"])},
      {:eex, "registration_view.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_registration", "view.ex"])},
      {:eex, "reset_password_view.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_reset_password", "view.ex"])},
      {:eex, "reset_password_controller.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_reset_password", "controller.ex"])},
      {:eex, "reset_password_controller_test.exs",
       Path.join([web_test_prefix, "modules", web_path, "#{schema.singular}_reset_password", "controller_test.exs"])},
      {:eex, "reset_password_edit.html.heex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_reset_password", "edit.html.heex"])},
      {:eex, "reset_password_new.html.heex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_reset_password", "new.html.heex"])},
      {:eex, "session_view.ex", Path.join([web_prefix, "modules", web_path, "#{schema.singular}_session", "view.ex"])},
      {:eex, "session_controller.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_session", "controller.ex"])},
      {:eex, "session_controller_test.exs",
       Path.join([web_test_prefix, "modules", web_path, "#{schema.singular}_session", "controller_test.exs"])},
      {:eex, "session_new.html.heex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_session", "new.html.heex"])},
      {:eex, "settings_view.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_settings", "view.ex"])},
      {:eex, "settings_edit.html.heex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_settings", "edit.html.heex"])},
      {:eex, "settings_controller.ex",
       Path.join([web_prefix, "modules", web_path, "#{schema.singular}_settings", "controller.ex"])},
      {:eex, "settings_controller_test.exs",
       Path.join([web_test_prefix, "modules", web_path, "#{schema.singular}_settings", "controller_test.exs"])}
    ]
  end
